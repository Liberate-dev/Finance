...
import { Camera, Check, Edit3, Loader2, ScanLine, Upload } from "lucide-react";
...
export default function ScanPage() {
	...
	const handleSave = async () => {
		...
		try {
			...
			showToast(getErrorMessage(error, "Gagal menyimpan transaksi hasil scan"), "error");
		}
	};
			...
			{step === "done" && (
				<div className={styles.doneState}>
					...
					<p style={{ color: "var(--text-secondary)" }}>
						Transaksi {formatCurrency(parseFloat(extractedAmount || "0"))} telah
						dicatat
					</p>
					<button
						className="btn btn-primary"
