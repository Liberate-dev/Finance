...
export default function BudgetPage() {
	...
	const [formPeriod, setFormPeriod] = useState<"monthly" | "weekly" | "yearly">(
		"monthly",
	);
	...
	const totalSpent = useMemo(
		() => budgetData.reduce((s, b) => s + b.spent, 0),
		[budgetData],
	);
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			showToast(getErrorMessage(error, "Gagal menyimpan budget"), "error");
		}
	};
	...
	const handleDelete = async (id: string) => {
		try {
			...
			showToast(getErrorMessage(error, "Gagal menghapus budget"), "error");
		}
	};
	...
	return (
		<div className="page">
			...
			<div className="card-flat" style={{ marginBottom: "var(--space-lg)" }}>
				...
				{totalBudget > 0 && (
					<div className="progress-bar">
						<div
							className={`progress-bar-fill ${(totalSpent / totalBudget) * 100 >= 100
									? "danger"
						...
						<div key={b.id} className="card-flat">
							...
							>
								<div style={{ display: "flex", alignItems: "center", gap: 10 }}>
									...
									>
										<span style={{ color: b.catInfo?.color, fontSize: 16 }}>
											●
										</span>
									</div>
									<div>
							...
							<div className="flex-between">
								...
								>
									{b.remaining >= 0
										...
										: `Lebih ${formatCurrency(-b.remaining)}`}{" "}
			...
			<Modal
				...
				title={editId ? "Edit Budget" : "Tambah Budget"}
			>
				<form
					...
					<div className="form-row">
						...
						<div className="input-group">
							...
							<select
								className="input"
								value={formPeriod}
								onChange={(e) => setFormPeriod(e.target.value as "monthly" | "weekly" | "yearly")}
							>
